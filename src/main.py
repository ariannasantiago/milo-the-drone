# main program to run threads
# won't actually run until camera coordinates are complete and integrated with rules
...
# TODO: uncomment below line once camera branch has been merged
